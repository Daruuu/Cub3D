...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/28 09:29:22 by yamir             #+#    #+#             */
/*   Updated: 2025/06/01 01:14:23 by cpujades         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
static void	draw_sprite_column(t_img *img, t_vars *vars, t_sprite s,
		t_sprite_r *sp)
{
...
void	draw_sprite_line(t_img *img, t_vars *vars, t_sprite s, t_sprite_r sp)
{
	while (++sp.v.x < sp.draw.width && sp.draw.x + sp.v.x < img->width)
	{
		...
		draw_sprite_column(img, vars, s, &sp);
	}
}
